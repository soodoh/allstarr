...
const mocks = vi.hoisted(() => ({
	...
	matchAllFormats: vi.fn(() => []),
	parseReleaseGroup: vi.fn(),
	calculateCFScore: vi.fn(() => ({ totalScore: 0, matchedFormats: [] })),
	fetchQueueItems: vi.fn(() => ({ items: [], warnings: [] })),
	selectAll: vi.fn(() => []),
	selectGet: vi.fn(),
	...
	deleteRun: vi.fn(),
	tokenSetRatio: vi.fn(() => 100),
	partialRatio: vi.fn(() => 100),
}));
